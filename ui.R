...
SYMs <- read.csv("C:/Users/Naresh Vemula/AppData/Local/Temp/RtmpcPLN0I/shinyapp550c4ca91b2f/Financial-Options-Evaluation-master/SYMs.csv",stringsAsFactors =FALSE)
